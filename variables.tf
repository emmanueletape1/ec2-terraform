variable "application" {
  ...
  validation {
    ...
    error_message = "Value \"${var.application}\" entered for application is not found."
  }
...
variable "env" {
  ...
  validation {
    ...
    error_message = "Value \"${var.env}\" entered for environment type is not found."
  }
}
...
variable "location" {
  ...
  validation {
    ...
    error_message = "Value \"${var.location}\" entered for location is not found."
  }
}
...
variable "infra_type" {
  ...
  validation {
    ...
    error_message = "Value \"${var.infra_type}\" entered for infrastructure type is not found."
  }
}
...
variable "resource_type" {
  ...
  validation {
    ...
    error_message = "Value \"${var.resource_type}\" entered for resource type is not found."
  }
}
...
variable "prefix" {
  ...
  validation {
    ...
    error_message = "The server name prefix value must be \"mot\", but you entered \"${var.prefix}\"."
  }
}

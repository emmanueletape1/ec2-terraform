...
variable "env" {
  ...
  # default     = "tn"
  validation {
    condition = contains(["dn","qn","tn","sn","pr"])
...
variable "location" {
  ...
  # default     = "wev"
  validation {
    condition = contains(["oac","par","rtp","dal","tul","bld","pac","wev","weo","wwo","wwc","ze2","zc1","ze1","ze3","znc","zsc","zw1","zw2","zw3","zwc","ge1","ge4","gc1","gw1","gw2","gw3","gw4"])
